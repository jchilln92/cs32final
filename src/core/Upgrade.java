...
public class Upgrade implements IPurchasable {
	...
	//All of these fields represent percentage increases that will be added on to a current tower's values 
	//ex: an instantDamageChange value of 0.1 means a 10% increase in the towers instantDamage.
